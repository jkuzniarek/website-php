    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Stephen Wolfram <br> Theoretical Computing</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Joseph Campbell <br> Spirituality / Religion / Culture</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Jenny Odell <br> Mindfulness / Localism</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Richard P. Feynman <br> Biography / Humor</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Richard P. Feynman <br> Biography / Science</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Frederick Nietsche <br> Philosophy</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Malcom X <br> Biography / Civil Rights</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Reinhold Martin, Jacob Moore, Susanne Schindler <br> Architecture / Economics / Culture</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Colin Woodard <br> History / Culture</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Arthur Herman <br> History / Scottish Enlightment</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Paul Strathern <br> History / Biographical / Italian Renaissance</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Joseph Henrich <br> Culture / Psychology</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Orson Scott Card <br> Science Fiction</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          ...
          <p>Isaac Asimov <br> Science Fiction</p>
        </div>
      </div>
    </div>
